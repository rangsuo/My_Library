...
public class Utils {
    ...
    public boolean addToAlreadyRead(Book books){
        return alreadyReadBook.add(books);
    }
    ...
    public boolean addToCurrentlyReading(Book books){
        return currentlyReadingBook.add(books);
    }
